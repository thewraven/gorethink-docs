...
func main() {
	//El método Println nos permite escribir
	//una linea de texto en la terminal
	fmt.Println("¡Aún no nos han presentado! ¿Cuál es tu nombre?")

	//Scanln lee una entrada en el teclado como cadena.
	nombre := fmt.Scanln()

	//Go sabe que el resultado sera una cadena,
	//por eso 'nombre' es tipo cadena,
	//esto se puede hacer usando el operador
	//de declaración implícita, :=

	//Printf permite imprimir en terminal, utilizando
	//valores formateados, como en C.

	fmt.Printf("¡Hola %s!, ¡Gusto en conocerte \n ", nombre)

	//El primer argumento es la cadena a formatear,
	//los siguientes son los valores a reemplazar.
}
